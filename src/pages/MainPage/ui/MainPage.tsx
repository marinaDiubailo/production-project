...
const MainPage = () => {
  ...
  return (
    <Page data-testid="MainPage">
      ...
      <p>
        Добро пожаловать на нашу платформу! Мы создали это пространство, чтобы
        объединить людей с общими интересами, позволяя делиться знаниями и
        опытом в разных областях. Наша цель — создать сообщество, где каждый
        может найти полезную информацию, задать вопросы и получить ответы от
        экспертов и единомышленников.
      </p>
      <p>
