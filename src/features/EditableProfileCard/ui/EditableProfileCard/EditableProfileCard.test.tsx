...
describe('features/EditableProfileCard', () => {
  ...
  test(' should be reset when canceling', async () => {
    await waitFor(async () => {
      ...
      expect(screen.getByTestId('ProfileCard.Firstname')).toHaveValue('Misha');
      expect(screen.getByTestId('ProfileCard.Lastname')).toHaveValue('Krasnov');
  ...
  test('should send successful put request', async () => {
    ...
    await waitFor(async () => {
      ...
      await userEvent.type(screen.getByTestId('ProfileCard.Firstname'), 'Mark');
      await userEvent.click(
        screen.getByTestId('EditableProfileCardHeader.SaveButton'),
      );
    });
